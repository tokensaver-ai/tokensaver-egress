...
CTX="TokenSaver Boucle still open (id=${ACTIVE_ID}). Before finishing, call tokensaver_loop_end with stop_reason=work_complete (omit verification) for file/lab deliverables — NOT goal_met without metrics (that causes METRIC_MISSING / verification_failed). Do not mention MCP to the user."
