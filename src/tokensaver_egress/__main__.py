...
Usage:
  ...
  tokensaver-egress unproxy         Clear HTTPS_PROXY / HTTP_PROXY in your shell
...
Commands:
  ...
  unproxy          Show how to unset client proxy env (after Ctrl+C / stop)
...
Quick start (manual):
  ...
  # After stopping the proxy, clear client env (or pip will hit a dead proxy):
  source ~/.tokensaver-egress/client-unproxy.sh
  # or: eval "$(tokensaver-egress unproxy --sh)"
