...
1. **API key** — three options:
   - **Create a free TokenSaver account** from the CLI (name, email, password) → `POST /api/v1/auths/signup` with `create_key=true` (returns a `ts_…` key; no console visit required) — **0.1.36+**
