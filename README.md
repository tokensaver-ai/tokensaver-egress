...
## 5-minute setup (recommended: MITM)
...
|---------|----------------|
| `tokensaver-egress` | Show help (does **not** start the proxy) |
| `tokensaver-egress serve` | Start proxy on `0.0.0.0:8888` |
